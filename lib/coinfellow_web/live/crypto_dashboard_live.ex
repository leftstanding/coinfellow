defmodule CoinfellowWeb.CryptoDashboardLive do
  use CoinfellowWeb, :live_view

  def mount(_params, _session, socket) do
    products = Coinfellow.available_products()
    trades = 
      products
    ...
    if connected?(socket) do
      Enum.each(products, &Coinfellow.subscribe_to_trades(&1))
    end
