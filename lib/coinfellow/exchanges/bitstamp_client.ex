defmodule CoinFellow.Exchanges.BitstampClient do
  alias CoinFellow.{Trade, Product, Exchanges}
  alias CoinFellow.Exchanges.Client
  require Client
  ...
  def message_to_trade(%{"data" => data, "channel" => "live_trades_" <> currency_pair} = _msg) when is_map(data) do
